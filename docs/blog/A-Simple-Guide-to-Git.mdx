---
title: Git简单操作指南
description: Git 是一个免费的开源分布式版本控制系统，旨在快速高效地处理从小到大的项目。它易于学习，占用空间小，性能快如闪电。它凭借廉价的本地分支、方便的暂存区域和多个工作流程等功能能够帮助我们有效的管理我们的项目。
created_at: 2023-10-31T06:30:31Z
updated_at: 2023-11-23T03:47:26Z
labels:
  - Git
  - 文档
---
