...
export default function Side() {
  return (
    <div className="relative h-full w-full select-none">
      ...
      <Image src="/images/wallhaven-9dee1d.webp" fill className="absolute h-full w-full object-cover" alt="" priority />
      ...
      <div className="absolute bottom-2 left-0 right-0 text-center text-white md:bottom-1/4">
        <h1 className="p-2 text-3xl md:p-4 md:text-4xl">LycixRemix</h1>
